...
if __name__ == "__main__":
	train(5000,Data,device,Train_list,Test_list,model,model2,optimizer1,optimizer2,optimizer3,loss_fn,loss_fn_3,mini_Labels_dict, Labels, Initial_Features,model3,AtomSymble_One_Hot,EP_list)
